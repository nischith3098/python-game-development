...
if answer == "left":
    ...
    if answer == "back":
        ...
        if answer == "yes":
            print("You talk to the stranger and they give you a two pronged key for opening the golden chest. You WIN!!!")

        elif answer == "no":
            print("You said no and lost gaining the key from a stranger. YOU LOSE!!!")
